...
public class WallRecyclerAdapter extends RecyclerView.Adapter<WallRecyclerAdapter.ViewHolder>{

    WallRecyclerAdapter.OnClick onClick;
    ...
    public WallRecyclerAdapter(ArrayList<Post> mData, WallRecyclerAdapter.OnClick context, String loggedInUserId) {
        this.mData = mData;
    ...
    @Override
    public WallRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.posts_layout_home, parent, false);
        WallRecyclerAdapter.ViewHolder vh = new WallRecyclerAdapter.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(WallRecyclerAdapter.ViewHolder holder, int position) {
        ...
        if (postObj.getUserId().equals(userId)){
